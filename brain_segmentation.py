...
path = "./input/image1.png" # Your image pa v th 
img = Image.open(path)
members = [(0,0)] * 9
# print img.width
...
newimg.save('./denoised_image/denoised.jpg')
...
img = cv2.imread('./denoised_image/denoised.jpg')
Z = img.reshape((-1,3))
...
no_clusters = int(input("Enter the no. of clusters: "))
...
output.save('./segmented_image/segmented.jpg')
...
img = cv2.imread('./segmented_image/segmented.jpg',0)
print("A")
ret,thresh1 = cv2.threshold(img,150,255,cv2.THRESH_BINARY)
print("B")
output = PIL.Image.fromarray(thresh1)
output.save('./after_thresholding/after_thresholding.jpg')
print("C")
